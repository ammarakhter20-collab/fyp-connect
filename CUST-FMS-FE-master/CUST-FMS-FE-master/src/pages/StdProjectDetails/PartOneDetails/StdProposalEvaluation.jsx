...
const ProposalEvaluation = ({ data, accordionId, remarksData }) => {
    useEffect(() => {
        initFlowbite();
  ...
  return (
    <div id={`accordion-collapse-${accordionId}`} data-accordion="collapse" className='mt-1'>
      <h2 id={`accordion-collapse-heading-timetable-${accordionId}`}>
        <GenAccor text="Proposal Evaluation" accordionId={accordionId} />
      </h2>
                  ...
                  <table className="w-full text-sm text-left rtl:text-center text-black bg-white   border-collapse border border-gray-300">
                    <thead className="text-xs text-indigo-900 uppercase bg-white    ">
                      <tr className='border-b text-center'>
                        ...
                        <th className="px-6 py-3  w-52">Q4(10)</th>
                        <th className="px-6 py-3  w-52">Q5(10)</th>
                        <th className="px-6 py-3  w-52">Q6(10)</th>
                    ...
                    <tbody>
                        ...
                        <tr className="text-center font-normal">
                          ...
                          <td className="px-6 py-4 ">{data.Q4}</td>
                          <td className="px-6 py-4 ">{data.Q5}</td>
                          <td className="px-6 py-4 ">{data.Q6}</td>
