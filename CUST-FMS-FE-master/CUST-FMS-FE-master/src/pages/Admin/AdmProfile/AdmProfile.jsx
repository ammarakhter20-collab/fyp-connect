...
// import dummyData from '../../StudProfile/StddummyStudProfile'
...
// console.log("Admin Data", AdmData.password);
const  hashedPassword  = AdmData.password;
...
useEffect(() => {
  // Initialize formData when AdmData changes
  setFormData({
    name: AdmData.name || '',
    email: AdmData.email || '',
    secondaryEmail: AdmData.secondaryEmail || '',
    phoneNumber: AdmData.phoneNumber || '',
    address: AdmData.address || '',
  });
}, [AdmData]);
...
// };
  ...
  console.log("Checking admin data", AdmData);
  ...
  //     // // Extract the userId from the userData
  //     const user = userData._id;
  //     console.log("Chekcing user id", user);
  //     formData.append('user', user);

  //     // Send the file and user ID to the server
  //     const response = await axios.post(
  //       '/api/auth/uploadProfilePicture',
  //       formData, // Send formData only, which includes the file and user ID
  //       {
  //         headers: {
...
// console.log(token);
  ...
  // const [formData, setFormData] = useState({
  //   Name: AdmData.name,
  //   PrimaryEmail: AdmData.email,
  //   secondaryEmail: AdmData.secondaryEmail,
  //   ContactNumber: AdmData.phoneNumber,
  //   Address: AdmData.address,
  // });

  console.log("formData Name checking", AdmData.name);

  console.log("Checking admin data", AdmData.image);
  console.log('Image URL:', `/assets/images/${AdmData.image}`);
  return (
    <>
                  ...
                  <div className='p-5 pt-2'>
                    ...
                    <div className='regCgpa flex flex-col justify-center space-y-2 text-xs ml-1 mt-2'>
                      ...
                      <div className='text-center  flex flex-row justify-center space-x-2'>
                        ...
                        <p className='font-light'>{AdmData ? AdmData.extension : 'Loading...'}</p>
                      </div>
                      <div className='text-center  flex flex-row justify-center space-x-2'>
