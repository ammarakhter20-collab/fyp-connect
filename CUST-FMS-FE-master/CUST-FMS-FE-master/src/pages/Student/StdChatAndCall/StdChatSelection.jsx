...
const ChatSelection = ({ onSelectChat }) => {
  ...
  return (
    <div>
      ...
      >
        <ul
          className="py-2 text-sm text-gray-700 ml-5"
        ...
        >
          <li>
            <a
              ...
              onClick={() => handleChatSelect('groupMembers')} // Handle click event and pass the selected chat
            >
              Group Members
            </a>
          </li>
          <li>
            <a
              href="#"
              className="block px-4 py-2 hover:bg-gray-300"
              onClick={() => handleChatSelect('supervisor')} // Handle click event and pass the selected chat
            >
              Supervisor
            </a>
          </li>
          <li>
            <a
              href="#"
              className="block px-4 py-2 hover:bg-gray-300"
              onClick={() => handleChatSelect('coordinator')} // Handle click event and pass the selected chat
            >
              Coordinator
            </a>
          </li>
          <li>
            <a
              href="#"
              className="block px-4 py-2 hover:bg-gray-300"
              onClick={() => handleChatSelect('hod')} // Handle click event and pass the selected chat
            >
              Head of Department
            </a>
          </li>
