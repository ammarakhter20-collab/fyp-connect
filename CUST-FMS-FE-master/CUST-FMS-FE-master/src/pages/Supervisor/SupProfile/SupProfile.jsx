...
const StudProfile = ({ isFYPRegistered }) => {
  ...
  // const [PriEmailEdit, setPriEmailEdit] = useState(false);
  // const [formData, setFormData] = useState({
  //   secondaryEmail:  '', // Initialize with user's secondaryEmail if available
  // });
  const [formData, setFormData] = useState({
    name: '',
    email: '',
  ...
  const handleUpdateProfileData = async () => {
    ...
    // You can add your update logic here, such as calling an API to update the data
    ...
    try {
      ...
      // Construct formData with userId included
      const updatedFormData = {
        user, // Add userId to formData
        // Include other form fields from state
        name: formData.name,
      ...
      // Send a PATCH request to update the profile data
      ...
      // Hide loading spinner after update completes
      setLoadingSpinner(false);
    }
  };
    ...
    <>
      {loadingSpinner ? ( // Show loading spinner while loading is true
        ...
        <div>
          ...
          <div className='ProfileForm bg-white border border-gray-200 mx-40 mt-14 rounded-lg py-3 '>
            ...
            <form class="max-w-5xl  mx-auto mt-4 px-4">
              ...
              <div className="grid md:grid-cols-2 md:gap-6">
                <div className="relative z-0 w-full mb-5 group">
                  ...
                  <input
                    type="text"
                    name="name"
                    className={`block py-2.5 px-0 w-full text-lg font-semibold text-gray-900 bg-transparent border-b-2 border-gray-300 border-dotted focus:outline-none focus:border-primary appearance-none ${editable ? "" : "disabled"
                      }`}
                    placeholder=" "
                    value={formData.name}
                ...
                <div className="relative z-0 w-full mb-5 group">
                  <input
                    type="text"
                    name="email"
                    className={`block py-2.5 px-0 w-full text-lg font-semibold text-gray-900 bg-transparent border-b-2 border-gray-300 border-dotted focus:border-primary focus:outline-none appearance-none ${editable ? "" : ""
                      }`}
                    placeholder=" "
                    value={formData.email}
                    onChange={handleInputChange}
                  // disabled={!PriEmailEdit}
                  />
                  <label
                    htmlFor="floating_phone"
                    className="peer-focus:font-medium absolute text-xl font-light text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
              ...
              <div className="grid md:grid-cols-2 md:gap-6 mt-4">
                <div className="relative z-0 w-full mb-5 group">
                  <input
                    type="text"
                    name="secondaryEmail"
                    className={`block py-2.5 px-0 w-full text-lg font-semibold text-gray-900 bg-transparent border-b-2 border-gray-300 focus:border-primary focus:outline-none appearance-none ${editable ? "" : ""
                      }`}
                    placeholder=" "
              ...
              <div className="flex justify-end">
                ...
                <ButbgPrimary
                  ...
                  className={`${editable ? "" : "hidden" // Hide when editable is false
                    }`}
                />
              </div>
            </form>
          ...
          <div className='ChnagePassword bg-white border border-gray-200 mx-40 mt-14 rounded-lg py-3'>
            ...
            <form class="max-w-5xl mt-6 mx-4">
              <div className="relative z-0 w-full mb-5 group">
                <input
                ...
                />
                <label htmlFor="floating_phone" className="peer-focus:font-medium absolute text-xl font-normal text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                  Old Password
                </label>
                <span
