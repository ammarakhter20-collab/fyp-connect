...
router.get(
  "/getCoordinators/:departmentId",
  authMiddleware,
  GenUserController.fetchCoordinatorByDepartment
);
router.get(
...
router.post("/usercreation", authMiddleware, GenUserController.createGenUser);
router.post(
  "/checkUserExistence",
  authMiddleware,
  GenUserController.checkUserExist
);
router.get(
  "/getCoordinatorId",
  authMiddleware,
